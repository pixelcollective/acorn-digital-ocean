...
namespace TinyPixel\Acorn\DigitalOcean\Adapters;
...
use TinyPixel\Acorn\DigitalOcean\Storage\Spaces;

class SpacesCloudStorageServiceProvider extends ServiceProvider
{
    /**
