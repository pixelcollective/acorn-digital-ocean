<?php
namespace TinyPixel\Acorn\DigitalOcean\Console\Commands\DigitalOceanUploadCommand;

use Aws\S3\Transfer;
use Roots\Acorn\Console\Commands\Command as RootsCommand;

class DigitalOceanUploadCommand extends RootsCommand
{
/**
